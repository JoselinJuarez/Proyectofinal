...
<div class="form-container">
        ...
        <form action="{{route('create.garantia')}}" method="post">
            
            @csrf
            <!--<label for="nombre">Numero:</label>
            <input type="number" id="nombre" name="numero" required>!-->
            <label for="nombre">Nombre:</label>
            <input type="text" id="nombre" name="nombree" required>
            

            <!--<label for="email">Fecha_de_inicio:</label>
            <input type="text" id="email" name="inicio" required>!-->

            <label for="telefono">Monto:</label>
            <input type="number" id="telefono" name="fin">

            <!--<label for="mensaje">Monto:</label>
            <input id="mensaje" name="monto" type="text">!-->
            <label for="mensaje">Descripcion</label>
            <input id="mensaje" name="monto" type="text">

            <label for="nombre">Valor evaluado:</label>
            <input type="text" id="nombre" name="var" required>
            <label for="nombre">estado:</label>
            <input type="text" id="nombre" name="estado" required>
            ...
            <a href="/garantias" class="active"><i class="fas fa-users"></i><span>prestamos</span></a>
