...
<div class="form-container">
        ...
        <form action="{{route('prestamos.create')}}" method="post">
            ...
            <input type="date" id="telefono" name="fin">
            ...
            <a href="/prestamos" class="active"><i class="fas fa-users"></i><span>prestamos</span></a>
