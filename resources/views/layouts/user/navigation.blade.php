<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('garantias.index')" :active="request()->routeIs('garantias.index')">
                        Garantías
                    </x-nav-link>
                    ...
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div class="flex items-center">
                                <div class="rounded-full border-sky-950 border-2"
                                ...
                                <div class="ms-2">{{ Auth::user()->name . " - " . Auth::user()->role }}</div>
                            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('garantias.index')" :active="request()->routeIs('garantias.index')">
                Garantías
            </x-responsive-nav-link>
